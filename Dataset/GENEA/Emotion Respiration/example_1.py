...
data_path = '/Users/Rozemarijn/Desktop/Thesis_CNP/data_analysis/04051610_respdata.csv'
timing_path = '/Users/Rozemarijn/Desktop/Thesis_CNP/data_analysis/04051610_timing.csv'
...
ax2.plot(baseline_time_array, fil_baseline_abdomen)
...
ax2.plot(speech_time_array, fil_speech_abdomen)
ax1.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax2.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax1.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
ax2.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
...
plt.savefig('speechplotCA.png', format="png", dpi=1200)
plt.tight_layout()
plt.show()
...
ax2.plot(speech_time_array2, fil_speech_abdomen2)
ax1.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax2.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax1.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
ax2.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
...
plt.savefig('speechplotCA2.png', format="png", dpi=1200)
plt.tight_layout()
plt.show()
...
ax2.plot(speech_time_array3, fil_speech_abdomen3)
ax1.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax2.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax1.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
ax2.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
...
plt.savefig('speechplotCA3.png', format="png", dpi=1200)
plt.tight_layout()
plt.show()
...
ax2.plot(speech_time_array4, fil_speech_abdomen4)
ax1.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax2.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax1.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
ax2.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
...
plt.savefig('speechplotCA4.png', format="png", dpi=1200)
plt.tight_layout()
plt.show()
...
for i in range(4):
    ...
    ax2.plot(song_time_array[i], fil_song_abdomen)
    ax1.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
    ax2.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
    ax1.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
    ax2.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
