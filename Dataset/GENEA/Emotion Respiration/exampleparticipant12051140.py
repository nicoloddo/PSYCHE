...
'''
data_path = '12051140_respdata.csv'
timing_path = '12051140_timing.csv'
...
speech_data_abdomen2, speech_data_chest2 = resp_data.loc[958.8333159 + time_delta: 958.8333159 + 45 + time_delta].to_numpy().T
time_array3 = resp_data.loc[958.8333159 + time_delta: 958.8333159 + 45 + time_delta].index.to_numpy()
...
speech_data_abdomen4, speech_data_chest4 = resp_data.loc[1175.161944 + time_delta: 1175.161944 + 45 + time_delta].to_numpy().T
time_array5 = resp_data.loc[1175.161944 + time_delta: 1175.161944 + 45 + time_delta].index.to_numpy()
...
ax2.plot(baseline_time_array, fil_baseline_abdomen, c = 'green')
...
plt.savefig("baselineplot_12051440.png", format="png", dpi=1200)
plt.show()
...
plt.savefig('speechplot_happy.png', format="png", dpi=1200)
plt.tight_layout()
plt.show()
...
ax2.plot(speech_time_array2, fil_speech_abdomen2, c = 'green')
ax1.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax2.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax1.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
ax2.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
#ax1.set_title('Filtered chest respiration signal during speech after the first sad song')
#x2.set_title('Filtered abdomen respiration signal during speech after the first sad song')
#ax1.set_xlabel('Time [seconds]')
#ax2.set_xlabel('Time [seconds]')
ax1.set_ylim([-1.5, 1.5])
ax2.set_ylim([-1.5, 1.5])
...
plt.savefig('speechplot_sad.png', format="png", dpi=1200)
plt.tight_layout()
plt.show()
...
ax2.plot(speech_time_array3, fil_speech_abdomen3, c = 'green')
ax1.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax2.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax1.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
ax2.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
...
plt.savefig('speechplot_happy2.png', format="png", dpi=1200)
plt.tight_layout()
plt.show()
...
ax2.plot(speech_time_array4, fil_speech_abdomen4, c = 'green')
ax1.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax2.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
ax1.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
ax2.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
#ax1.set_title('Filtered chest respiration signal')
#ax2.set_title('Filtered abdomen respiration signal')
#ax1.set_xlabel('Time [seconds]')
#ax2.set_xlabel('Time [seconds]')
ax1.set_ylim([-1.5, 1.5])
ax2.set_ylim([-1.5, 1.5])
...
plt.savefig('speechplot_sad2.png', format="png", dpi=1200)
plt.tight_layout()
plt.show()
...
for i in range(4):
    ...
    ax2.plot(song_time_array[i], fil_song_abdomen, c = 'green')
    ax1.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
    ax2.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_x))
    ax1.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
    ax2.yaxis.set_major_locator(ticker.MultipleLocator(tick_spacing_y))
    ...
    plt.savefig(f'songsplot {i + 1}_12051140.png', format="png", dpi=1200)
    plt.tight_layout()
    plt.show()
