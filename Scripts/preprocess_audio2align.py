...
def main(args):
    ...
    print("Transcriptions done. Now use Montreal Forced Aligner (which is yet not supported to be started from here), and start the Gentle Aligner Docekr image.")
